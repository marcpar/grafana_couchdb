...
function (_super) {
  ...
  function QueryEditor(props) {
    ...
    _this.onDatabaseChange = function (database) {
      if (_this.props.query.database !== database) {
        _this.props.query.database = database;
        _this.props.query.designDoc = null;
        _this.props.query.view = null;
        var _a = _this.props,
            onChange = _a.onChange,
            query = _a.query;
        onChange(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, query), {
        ...
        _this.getDesignDocumentList();
      }
    };

    _this.onDesignDocChange = function (designDoc) {
      if (_this.props.query.designDoc !== designDoc) {
        _this.props.query.designDoc = designDoc;
        _this.props.query.view = null;
        var _a = _this.props,
            onChange = _a.onChange,
            query = _a.query;
    ...
    _this.onFieldChange = function (fields) {
      var _a = _this.props,
          onChange = _a.onChange,
          query = _a.query,
          onRunQuery = _a.onRunQuery;
      ...
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4
            /*yield*/
            , this.props.datasource.findDatabases()];
  ...
  QueryEditor.prototype.getDesignDocumentList = function () {
    var _a;

    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
      var _b, query, datasource, _c, _d;
      ...
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_f) {
        switch (_f.label) {
          case 0:
            _b = this.props, query = _b.query, datasource = _b.datasource;
            _c = this.setState;
            _e = {};
            if (!(typeof ((_a = query.database) === null || _a === void 0 ? void 0 : _a.value) !== 'undefined')) return [3
            /*break*/
            , 2];
            return [4
            /*yield*/
            , datasource.findDesignDocs(query.database)];
          ...
          case 3:
            _c.apply(this, [(_e.designDocs = _d, _e)]);
  ...
  QueryEditor.prototype.getViewList = function () {
    var _a, _b;

    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
      var _c, query, datasource, isUndefined, _d, _e;
      ...
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_g) {
        switch (_g.label) {
          case 0:
            _c = this.props, query = _c.query, datasource = _c.datasource;
            isUndefined = typeof ((_a = query.designDoc) === null || _a === void 0 ? void 0 : _a.value) !== 'undefined' && typeof ((_b = query.database) === null || _b === void 0 ? void 0 : _b.value) !== 'undefined';
            _d = this.setState;
            _f = {};
            if (!isUndefined) return [3
            /*break*/
            , 2];
            return [4
            /*yield*/
            , datasource.findViews(query.database, query.designDoc)];
  ...
  QueryEditor.prototype.onChangeViewOption = function (view) {
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        return [2
        /*return*/
  ...
  QueryEditor.prototype.render = function () {
    ...
    return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_2___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
      ...
      width: "auto"
    }, "Database "), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(Select, {
      ...
      width: "auto"
    }, "Design Document "), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(Select, {
      ...
      width: "auto"
    }, "View"), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(Select, {
      ...
      width: "auto"
    }, "Fields"), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["MultiSelect"], {
...
function (_super) {
  ...
  function DataSource(instanceSettings) {
    ...
    _this.url = instanceSettings.url === undefined ? '12' : instanceSettings.url;
  ...
  DataSource.prototype.doRequest = function (path, options) {
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
      var result;
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        switch (_a.label) {
  ...
  DataSource.prototype.getViewLastPage = function (database, designDoc, view, limit) {
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
      var response, skip;
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4
            /*yield*/
            , this.doRequest("/" + database + "/" + designDoc + "/_view/" + view + "?limit=0", {})];
          ...
          case 1:
            ...
            skip = response.data.total_rows - limit;
            return [2
            /*return*/
            , skip < 0 ? "skip=0&limit=" + limit : "skip=" + skip + "&limit=" + limit];
        }
      });
    });
  };

  DataSource.prototype.getGraph = function (database, designDoc, view, from, path) {
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
      var to, limit, lastPage, url;
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        switch (_a.label) {
          case 0:
            to = +new Date();
            limit = Math.floor((to - from) / 1000);
            return [4
            /*yield*/
            , this.getViewLastPage(database, designDoc, view, limit)];

          case 1:
            lastPage = _a.sent();
            url = "/" + database + "/" + designDoc + "/_view/" + view + "?" + lastPage;
            return [2
            /*return*/
            , this.doRequest(typeof path === 'undefined' ? url : url + "&" + path, {})];
        }
      });
    });
  };
          ...
          case 0:
            ...
            , Promise.all(options.targets.map(function (target) {
              return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(_this, void 0, Promise, function () {
                var _undefined, database, designDoc, view, from, query, response, frame, fields, key, i, time, _key, value, data_1;

                return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                  switch (_a.label) {
                    case 0:
                      _undefined = typeof target.database === 'undefined' || typeof target.designDoc === 'undefined' || typeof target.view === 'undefined';
                      ...
                      database = target.database.value;
                      designDoc = target.designDoc.value;
                      view = target.view.value;
                      from = Date.parse(options.range.from.toString());
                      query = lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()(target, _types__WEBPACK_IMPORTED_MODULE_4__["defaultQuery"]);
                      return [4
                      /*yield*/
                      , this.getGraph(database, designDoc, view, from, query.path)];
                    ...
                    case 1:
                      ...
                      for (i = response.data.rows.length - 1; i >= 0; i--) {
                        time = response.data.rows[i].key;

                        for (_key in response.data.rows[i].value) {
                          value = response.data.rows[i].value[_key];
  ...
  DataSource.prototype.findDatabases = function () {
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, Promise, function () {
      var database;
      ...
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        ...
        return [2
        /*return*/
        , new Promise(function (resolve, regject) {
          _this.doRequest('/_all_dbs', {
            url: _this.url,
            method: 'GET'
          }).then(function (body) {
  ...
  DataSource.prototype.findDesignDocs = function (database) {
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, Promise, function () {
      var designDocs;
      ...
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        ...
        /*return*/
        , new Promise(function (resolve, regject) {
          _this.doRequest("/" + database.value + "/_design_docs", {
            url: _this.url,
            method: 'GET'
          }).then(function (body) {
            body.data.rows.forEach(function (value) {
              designDocs.push({
                label: value.id,
                value: value.id
              });
  ...
  DataSource.prototype.findViews = function (database, viewDoc) {
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, Promise, function () {
      var views;
      ...
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        ...
        /*return*/
        , new Promise(function (resolve, regject) {
          _this.doRequest("/" + database.value + "/" + viewDoc.value, {
            url: _this.url,
            method: 'GET'
          }).then(function (body) {
            Object.keys(body.data.views).forEach(function (value) {
              views.push({
                label: value,
                value: value
              });
